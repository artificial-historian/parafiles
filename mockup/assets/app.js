  ...
  return `
    <section class="hero">
      <div class="hero-copy">
        ...
        <h1>Parafiles in a cozy Paralives mood</h1>
        <p>This static mockup uses the saved theme notes: cream surfaces, sage structure, coral actions, sky and lavender accents, and darker official-site moments for focus.</p>
...
function render() {
  ...
  document.title = `${routeMeta[state.route]} - Parafiles Theme Mockup`;
