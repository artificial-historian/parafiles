...
AUTHENTICATION_BACKENDS = ["fileshare.auth_backends.CaseInsensitiveModelBackend"]
...
PARAFILES_EMAIL_VERIFICATION_TIMEOUT = env_int("PARAFILES_EMAIL_VERIFICATION_TIMEOUT", 72 * 60 * 60)
...
PARAFILES_SIGNATURE_PRIVATE_KEY = os.environ.get("PARAFILES_SIGNATURE_PRIVATE_KEY", "")
PARAFILES_SIGNATURE_PUBLIC_KEY = os.environ.get("PARAFILES_SIGNATURE_PUBLIC_KEY", "")
